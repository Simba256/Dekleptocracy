...
const articleTemplates = [
  ...
  },
  {
    ...
    icon: '⛽',
    iconBg: '#fef3c7',
    topics: ['gas prices', 'diesel costs', 'fuel inflation', 'oil prices', 'transportation costs'],
  },
  {
    category: 'utilities',
    icon: '💡',
    iconBg: '#fef3c7',
    topics: ['electricity rates', 'water bills', 'gas bills', 'utility inflation', 'energy costs'],
  },
  {
    category: 'tech',
    icon: '📱',
  ...
  },
  {
    ...
    icon: '🏠',
    iconBg: '#dbeafe',
    topics: ['rent prices', 'home prices', 'mortgage rates', 'housing inflation', 'property taxes'],
  },
  {
    category: 'healthcare',
    icon: '🏥',
...
async function callLLM(prompt) {
  ...
  try {
    ...
    console.log(
      '⚠️  Is your MCP server running? Start it with: cd mcp_server && python http_server.py',
    );
    console.log('⚠️  Falling back to mock data...');
    throw error;
  }
...
function getMockArticleData(category = 'groceries', _topic = 'egg prices') {
  ...
  const mockArticles = {
    groceries: {
      ...
      description:
        'Recent data suggests egg prices increased in California markets, with industry reports citing supply pressures and production costs.',
      mainText:
      ...
      whyItHappened: [
        ...
        },
        {
          ...
          description:
            'Some jurisdictions have implemented animal welfare standards that may affect production economics. Additionally, broader market dynamics including supply chain conditions, seasonal demand patterns, and wholesale pricing trends influence retail egg prices. The interaction of these factors creates complex pricing environments that vary across different markets.',
        },
      ],
      chartData: [
        { month: 'Jan', value: 4.2 },
    ...
    fuel: {
      ...
      description:
        'Recent market data shows gas prices have increased in various regions, with analysts citing global market conditions and seasonal factors.',
      mainText:
    ...
    tech: {
      ...
      description:
        'Average smartphone prices hit $875 in 2025, up 18% from $742 in 2024, as semiconductor and battery tariffs raise production costs.',
      mainText:
    ...
    housing: {
      ...
      description:
        'U.S. median rent hit $1,950 monthly in 2025, a 9% increase from $1,789 in 2024, as housing supply fails to keep pace with demand.',
      mainText:
    ...
    healthcare: {
      ...
      description:
        'Average family health insurance premiums reached $785 monthly in 2025, an 11% increase from 2024, as medical costs outpace inflation.',
      mainText:
    ...
    education: {
      ...
      description:
        'Average public university tuition and fees reached $28,400 for 2025-26, an 8% increase as state funding fails to keep pace with costs.',
      mainText:
    ...
    transportation: {
      ...
      description:
        'Average used car prices stand at $29,200 in 2025, still 22% higher than 2019 despite slight declines from 2023 peaks.',
      mainText:
...
function generateSources(category, _topic) {
  const sourcesMap = {
    groceries: [
      {
        title: 'USDA Weekly Market Report',
        url: 'https://www.ams.usda.gov/',
        publishedDate: new Date(),
      },
      {
        title: 'Bureau of Labor Statistics - Food Prices',
    ...
    utilities: [
      ...
      {
        title: 'State Public Utility Commissions',
    ...
    tech: [
      ...
      {
        title: 'TechCrunch Market Analysis',
    ...
    healthcare: [
      ...
      {
        title: 'Healthcare Cost Institute',
...
function selectHeroImage(category) {
  ...
  const images = {
    ...
    housing:
      'https://images.unsplash.com/photo-1582407947304-fd86f028f716?w=1200&h=600&fit=crop&q=80',
    healthcare:
    ...
    transportation:
      'https://images.unsplash.com/photo-1485463611174-f302f6a5c1c9?w=1200&h=600&fit=crop&q=80',
  };
...
async function removeDuplicateArticles() {
  try {
    ...
    if (duplicateIds.length > 0) {
      ...
      console.log(
        `🧹 Removed ${result.deletedCount} duplicate articles (${titleMap.size} unique remain)`,
      );
  ...
  try {
    ...
    for (const template of selectedTemplates) {
      try {
        ...
        let enhancedPrompt = generateArticlePrompt(
          template.category,
        ...
        const llmResponse = await callLLMWithContext(
          enhancedPrompt,
          template.category,
          template.selectedTopic,
        );
        ...
        while (slugExists) {
          ...
          if (slugCounter > 10) {
            console.log(
              `  ⚠️  Article with slug "${baseSlug}" already exists, skipping duplicate...`,
            );
...
export { generateArticles, articleTemplates, generateArticlePrompt, removeDuplicateArticles };
