...
const productImpactSchema = new mongoose.Schema({
  ...
  category: {
    ...
    enum: ['housing', 'groceries', 'fuel', 'utilities', 'tech', 'healthcare', 'education', 'transportation', 'apparel'],
    index: true
  },
  ...
  drivers: [{
    ...
    type: { type: String, enum: ['tariff', 'supply-chain', 'labor', 'fuel', 'currency', 'weather', 'policy', 'lobbying'] },
