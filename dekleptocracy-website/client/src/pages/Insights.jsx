      ...
      <div className="insights-page">
        <div className="insights-container">
          <div className="insights__error">
            ...
            <button onClick={() => window.location.reload()} className="insights__retry-btn">
              Try Again
            </button>
          </div>
        </div>
      ...
      <div className="insights-page">
        <div className="insights-container">
          <div className="insights__empty">
            ...
            <button onClick={() => navigate('/insights')} className="insights__retry-btn">
              View All Articles
            </button>
          </div>
        </div>
  ...
  return (
    <div className="insights-page">
      <SEO
        ...
        description={
          insightData.description || `Policy impact analysis for ${insightData.location}`
        }
        ...
        <div className="insights-hero-image">
          <img
            ...
            onError={(e) => {
              ...
              e.target.src =
                'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=1200&h=600&fit=crop&q=80';
            }}
          />
        </div>
          ...
          <div className="insights-right-column">
            ...
            <div className="insights-impact-score">
              ...
              <p className="insights-impact-description">
                This score reflects the impact on household budgets. A higher score indicates
                stronger inflationary pressure and greater consumer burden.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <>
                    ...
                    <div className="insights-chart-area">
                      ...
                      >
                        ...
                        <g
                          transform={`translate(${Math.min(lastPoint.x - 50, 300)}, ${lastPoint.y})`}
                        >
        ...
        {filteredArticles.length === 0 ? (
          <div className="insights__empty-grid">
            ...
            <h2 className="insights__empty-title">
              {selectedLocation === 'all'
                ? 'No Articles Yet'
                : `No Articles for ${selectedLocation}`}
            </h2>
              ...
              .map((article) => (
                <div key={article._id} className="all-insights-card">
                  <div className="all-insights-hero">
                    ...
                    <div
                      className={`content-type-badge content-type-badge--${article.contentType === 'research' ? 'research' : 'article'}`}
                    >
                  ...
                  <div className="all-insights-content">
                    ...
                    <div className="all-insights-meta">
                      Published: {new Date(article.publishedAt).toLocaleDateString()} • Views:{' '}
                      {article.views || 0}
                    </div>
                    ...
                    <button
                      ...
                      onClick={() =>
                        navigate(
                          `/insights?category=${article.category}&slug=${article.slug}&state=${state}`,
                        )
                      }
                    >
                      See details →
