  ...
  return (
    <div className="reports-page">
      ...
      <div className="reports-container">
        {/* Top Banner */}
        <div className="reports-banner">FROM THE DEKLEPTOCRACY PLATFORM</div>
        ...
        <div className="reports-card">
          ...
          <div className="reports-role-section">
            ...
            <div className="reports-role-cards">
              {roles.map((role) => (
                ...
                >
                  <div className="reports-role-icon">{role.icon}</div>
          ...
          {/* Generate Button */}
          <button className="reports-generate-button" onClick={handleGenerateReports}>
            Generate my reports
          </button>
        </div>
      </div>
