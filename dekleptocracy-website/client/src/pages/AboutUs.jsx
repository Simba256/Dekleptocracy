            ...
            <div className="core-values-grid">
              ...
              <div className="core-value-card">
                ...
                <div className="value-content">
                  ...
                  <p className="value-description">
                    We do what's right, not what's easy upholding honesty, transparency, and
              ...
              <div className="core-value-card">
                ...
                <div className="value-content">
                  ...
                  <p className="value-description">
                    Driven by progress, we continuously adopt smarter technologies and creative
                    solutions to meet evolving industry needs.
                  </p>
                </div>
              </div>
              ...
              <div className="core-value-card">
                ...
                <div className="value-content">
                  ...
                  <p className="value-description">
                    We champion a culture of safety, protecting our people, clients, and communities
                    with rigorous standards and practices.
                  </p>
                </div>
              </div>
              ...
              <div className="core-value-card">
                ...
                <div className="value-content">
                  ...
                  <p className="value-description">
                    Our clients count on us to deliver consistent results on time, every time with
        ...
        <div className="experts-section">
          <div className="experts-container">
            ...
            <p className="experts-subtitle">
              Our team is made up of seasoned engineers, project managers, and technical specialists
            ...
            <div className="experts-cta">
              <button className="ask-ai-button-experts" onClick={() => navigate('/chatbot')}>
                Ask AI
              </button>
            </div>
          </div>
        ...
        <div className="what-sets-us-apart-section">
          <div className="what-sets-us-apart-container">
            ...
            <div className="what-sets-us-apart-cta">
              <button className="ask-ai-button-what-sets" onClick={() => navigate('/chatbot')}>
                Ask AI
              </button>
            </div>
          </div>
          ...
          <div className="about-cta-container">
            <div className="about-cta-card">
              <div className="about-cta-content">
                <div className="about-cta-text">
                  ...
                  <p className="about-cta-description">
                    Join thousands of users who are already making informed decisions about their
                    finances based on real policy data.
                  </p>
                </div>
              ...
              <div className="about-cta-decoration">
                <svg
                  className="about-chain-decoration"
                  width="60"
                  height="60"
                  viewBox="0 0 24 24"
                  fill="none"
