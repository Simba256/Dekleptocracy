    ...
    <div className="terms-page">
      ...
      <div className="terms-container">
        ...
        <section className="terms-section">
          ...
          <p>
            By accessing and using Dekleptocracy ("the Service"), you accept and agree to be bound
            by the terms and provisions of this agreement. If you do not agree to these Terms of
        ...
        <section className="terms-section">
          ...
          <p>
            Dekleptocracy provides a platform for tracking and analyzing government policy impacts
            on household budgets and consumer costs. Our services include:
          </p>
          <ul>
        ...
        <section className="terms-section">
          ...
          <ul>
            ...
            <li>
              Violate or infringe upon the rights of others, including privacy, publicity,
              intellectual property, or other proprietary rights
            </li>
            <li>
              Post or transmit any content that is unlawful, threatening, abusive, defamatory,
              obscene, or otherwise objectionable
            </li>
            <li>
              Attempt to gain unauthorized access to the Service or any accounts, computer systems,
              or networks
            </li>
            <li>
            ...
            <li>
              Use any automated system, including "robots," "spiders," or "scrapers" to access the
              Service
            </li>
            <li>
        ...
        <section className="terms-section">
          ...
          <p>
            ...
            Dekleptocracy and are protected by international copyright, trademark, patent, trade
        ...
        <section className="terms-section">
          ...
          <p>
            You are solely responsible for any content you submit, post, or display on or through
          ...
          <p>
            ...
            that we determine in our sole discretion violates these Terms of Service or is otherwise
            objectionable.
          </p>
        </section>
        ...
        <section className="terms-section">
          ...
          <p>
            ...
            should not be considered as financial, legal, or professional advice. We do not
        ...
        <section className="terms-section">
          ...
          <p>
            TO THE MAXIMUM EXTENT PERMITTED BY LAW, DEKLEPTOCRACY SHALL NOT BE LIABLE FOR ANY
        ...
        <section className="terms-section">
          ...
          <p>
            You agree to indemnify, defend, and hold harmless Dekleptocracy and its officers,
        ...
        <section className="terms-section">
          ...
          <p>
            ...
            controlled by Dekleptocracy. We have no control over and assume no responsibility for
        ...
        <section className="terms-section">
          ...
          <p>
            ...
            jurisdiction in which Dekleptocracy operates, without regard to its conflict of law
            provisions.
          </p>
        </section>
